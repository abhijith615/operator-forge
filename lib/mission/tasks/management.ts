...
export const MANAGEMENT_TASKS: TaskTemplate[] = [
...

  {
    ...
    ttl: 50,
    build: () => ({
      title: "A food safety inspector is at the front door",
      detail: "Unannounced, which is how these work. She wants the temperature logs and a walk of the chill chain.",
      source: "Environmental health",
      options: [
        {
          id: "walk-her-round",
          label: "Take her round yourself, now",
          outcome: "Costs you ten minutes at the worst moment. Anything else reads as stalling.",
          quality: 0.95,
          capabilities: ["ownership", "communication", "stress-handling"],
        },
        {
          id: "delegate-inspector",
          label: "Ask the inventory lead to walk her round",
          outcome: "She knows the chill chain better than you do. It is also your name on the certificate.",
          quality: 0.6,
          capabilities: ["decision-making", "prioritization"],
        },
        {
          id: "ask-wait",
          label: "Ask her to wait until the peak is over",
          outcome: "She will note that she was asked to wait. That goes in the report.",
          quality: 0.05,
          capabilities: ["communication", "ownership"],
        },
      ],
    ...
    onExpire: {
      note: "She was left at the front door for the whole peak.",
...

  {
    ...
    ttl: 70,
    build: () => ({
      title: "A local reporter is asking about delivery times",
      detail: "She is writing about ten-minute promises in the area and wants a comment from someone on a floor.",
      source: "Reception",
      options: [
        {
          id: "route-to-comms",
          label: "Give her the press office contact and nothing else",
          outcome: "Boring, correct, and the reason companies have a press office.",
          quality: 0.9,
          capabilities: ["communication", "decision-making"],
        },
        {
          id: "off-record",
          label: "Give her a bit of colour off the record",
          outcome: "Nothing is off the record. Your name is on the roster for today.",
          quality: 0.05,
          capabilities: ["communication", "ownership"],
        },
        {
          id: "ignore-press",
          label: "Say you cannot help and go back to the floor",
          outcome: "Safe. Slightly worse than pointing her at someone who can help.",
          quality: 0.65,
          capabilities: ["prioritization"],
        },
      ],
    }),
    onExpire: { note: "She left without a comment and wrote it anyway." },
  },

  {
    id: "mgmt-training-overdue",
    stream: "management",
    priority: "normal",
    weight: 8,
    cooldown: 400,
    ttl: 140,
    build: () => ({
      title: "Three people are overdue on mandatory manual handling training",
      detail: "Twenty minutes each, online. Overdue training is what turns an accident into a liability.",
      source: "Compliance",
      options: [
        {
          id: "schedule",
          label: "Book all three into quiet windows this week",
          outcome: "Sixty minutes of cover to find. It gets done and it is on record.",
          quality: 0.9,
          capabilities: ["systems-thinking", "ownership"],
        },
        {
          id: "one-now",
          label: "Send one now, schedule the others",
          outcome: "Progress without pulling three people off a short floor.",
          quality: 0.85,
          capabilities: ["prioritization", "decision-making"],
        },
        {
          ...
          outcome: "It has already been pushed twice. That is why it is overdue.",
          quality: 0.15,
          capabilities: ["ownership"],
        },
      ],
    }),
    onExpire: { note: "The training stayed overdue." },
  },

  {
    ...
    ttl: 130,
    build: () => ({
      title: "Refrigeration is drawing 30% more power than last week",
      detail: "Same stock, same weather. Facilities have flagged it but not investigated.",
      source: "Facilities",
      options: [
        {
          id: "check-doors",
          label: "Have someone check the door seals before replying",
          outcome: "Usually a seal or a propped door. Two minutes to find out.",
          quality: 0.95,
          capabilities: ["curiosity", "systems-thinking"],
        },
        {
          id: "log-ticket",
          label: "Raise a facilities ticket",
          outcome: "Correct channel, seven-day response, and the units run hot until then.",
          quality: 0.6,
          capabilities: ["ownership"],
        },
        {
          id: "ignore-energy",
          label: "Not a store problem",
          outcome: "It is a cold chain problem wearing an energy bill.",
          quality: 0.15,
          capabilities: ["systems-thinking"],
        },
      ],
    }),
    onExpire: { note: "The power draw went unexplained." },
  },

  {
    ...
    ttl: 75,
    build: ({ world }) => ({
      title: "Another store is asking to borrow a rider",
      detail: `They are two riders down. You have ${world.riders.filter((r) => r.status === "idle").length} idle right now, and rain coming back.`,
      source: "Area group chat",
      options: [
        {
          id: "conditional",
          label: "Yes, for an hour, and say when you need them back",
          outcome: "Helps them, with a boundary you can hold.",
          quality: 0.95,
          capabilities: ["communication", "systems-thinking", "decision-making"],
        },
        {
          id: "yes",
          label: "Send one over",
          outcome: "Generous. You will be asking for them back at the worst moment.",
          quality: 0.5,
          capabilities: ["communication"],
        },
        {
          id: "no",
          label: "Decline — you are covering your own peak",
          outcome: "Defensible today. The area group has a long memory.",
          quality: 0.55,
          capabilities: ["prioritization"],
        },
      ],
    }),
    onExpire: { note: "The request went unanswered in the group." },
  },

  {
    ...
    ttl: 150,
    build: () => ({
      title: "Tomorrow's demand forecast needs signing off",
      detail: "The system has predicted a normal Tuesday. There is a cricket match at seven and rain forecast all day.",
      source: "Planning",
      options: [
        {
          id: "adjust",
          label: "Override it upward and say why",
          outcome: "More stock and more staff than the model wanted, with a reason attached.",
          quality: 0.95,
        ...
        },
        {
          id: "accept-forecast",
          label: "Sign it as-is",
          outcome: "The model is usually right. It has not heard of the cricket.",
          quality: 0.3,
          capabilities: ["decision-making"],
        },
        {
          id: "flag-only",
          label: "Sign it but flag the risk in the notes",
          outcome: "Covers you. Changes nothing about tomorrow.",
          quality: 0.55,
          capabilities: ["communication"],
        },
      ],
    }),
    onExpire: { note: "The forecast auto-approved unchanged." },
  },
];
