 ...
 * mission: `NEXT_PUBLIC_CHALLENGE_TIME_SCALE=20` runs the shift in 45 seconds
 * so the whole arc can be exercised. Forced to 1 in production builds — a
 * fifteen-minute shift is fifteen minutes.
 */
