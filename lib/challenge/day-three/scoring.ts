...
const TAG_PHASE: Partial<Record<Day3Tag, Phase>> = {
  ...
  riya_profile_opened: "pickers",
  riya_trend_reviewed: "pickers",
  riya_zone_data_checked: "pickers",
  riya_zone_c_pattern_found: "pickers",
  riya_accuracy_considered: "pickers",
  riya_moved_to_familiar_zone: "pickers",
  riya_paired_with_expert: "pickers",
  riya_coaching_scheduled: "pickers",
  riya_removed_unnecessarily: "pickers",
  riya_warned_without_diagnosis: "pickers",
  riya_untrained_role_assigned: "pickers",
  ...
  high_value_task_covered: "audit",
  high_value_control_ignored: "audit",
  expert_picker_backfilled: "audit",
  expert_picker_not_backfilled: "audit",
  used_temporary_transfer: "audit",
  strong_delegation: "audit",
  faisal_coached: "receiving",
  faisal_role_adjusted: "receiving",
  faisal_removed_unnecessarily: "receiving",
