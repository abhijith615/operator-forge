...
export type ChallengeEventName =
  ...
  | "people_issue_triggered"
  | "arjun_issue_opened"
  | "arjun_conversation_moved_private"
  | "arjun_incentive_checked"
  | "arjun_performance_checked"
  | "arjun_response_selected"
  | "arjun_overtime_requested"
  | "arjun_overtime_result"
  | "riya_issue_opened"
  | "riya_trend_viewed"
  | "riya_zone_performance_viewed"
  | "riya_intervention_selected"
  | "riya_projection_updated"
  | "people_module_completed"
