...
import { AVAILABILITY_COPY, AvailabilityBadge } from "@/components/shell/availability";
...
export function LockedPanel({ href, contents }: LockedPanelProps) {
  ...
  const copy = AVAILABILITY_COPY[item.availability];
  ...
  return (
    <PageShell>
      <PageHeader
        ...
        actions={<AvailabilityBadge availability={item.availability} />}
      />
