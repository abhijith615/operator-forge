...
const SECTIONS: LegalSection[] = [
      ...
      <>
        <ul>
          ...
          <li>
            ...
            completion for participants who complete all five simulations and attend the AMA.
          </li>
          <li>
  ...
  },
  {
    ...
    body: (
      <p>
        Participants who complete all five simulations (Days 1 to 5) and attend the live AMA on Day 7 receive a
        certificate of completion from Operator Forge, which confirms that they completed the programme. We record
        AMA attendance during the session. It carries the name on the account when it is first
